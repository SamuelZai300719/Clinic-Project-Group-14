                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-12">
                                <div class="card-box">
                                    ...
                                    <form class="parsley-examples" method="post" action="uppasienK.php" enctype="multipart/form-data">
                                    <?php
                                        require 'koneksi.php';
                                        $id = $_GET['id_pas'];
                                        $sql="SELECT * FROM pasien where id_pas='$id'";
                                    ...
                                    ?>
                                        ...
                                        <label>ID Pasien</label>
                                            <input class="form-control" name="id_pas" type="text" value="<?php echo $data['id_pas']; ?>">
                                        </div>

                                        <div class="form-group row">
                                        <label>Nama</label>
                                            <input class="form-control" name="nm_pas" type="text" value="<?php echo $data['nm_pas']; ?>">
                                        </div>

                                        <div class="form-group row">
                                        <label>Jenis Kelamin</label>
                                            <input class="form-control" name="jk_pas" type="text" value="<?php echo $data['jk_pas']; ?>">
                                        </div> 

                                        <div class="form-group row">
                                        <label>Alamat</label>
                                            <input class="form-control" name="almt" type="text" value="<?php echo $data['almt']; ?>">
                                        </div> 

                                        <div class="form-group row">
                                        <label>No. Telp / HP</label>
                                            <input class="form-control" name="tlp_pas" type="text" value="<?php echo $data['tlp_pas']; ?>">
                                        </div> 
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="">
                                                    ...
                                                    <button type="button" class="btn btn-danger waves-effect waves-light" onclick="window.location.href='pasien.php';">Cancel</button>
                                                </div>
                                            </div> <!-- /col -->
                                        </div> <!-- /row -->
                                    </form> <!-- /form -->
