                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="updokter.php">Edit Data Dokter</a></li>
                                        </ol>
                                    </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-12">
                                <div class="card-box">
                                    ...
                                    <form class="parsley-examples" method="post" action="updokterK.php" enctype="multipart/form-data">
                                    <?php
                                        require 'koneksi.php';
                                        $id = $_GET['id_dr'];
                                        $sql="SELECT * FROM dokter where id_dr='$id'";
                                    ...
                                    ?>
                                        ...
                                        <label>ID dokter</label>
                                            <input class="form-control" name="id_dr" type="text" value="<?php echo $data['id_dr']; ?>">
                                        </div>

                                        <div class="form-group row">
                                        <label>Nama dokter</label>
                                            <input class="form-control" name="nm_dr" type="text" value="<?php echo $data['nm_dr']; ?>">
                                        </div>
                                        ...
                                        <div class="form-group row">
                                        <label>No. Telp / HP dokter</label>
                                            <input class="form-control" name="tlp" type="text" value="<?php echo $data['tlp']; ?>">
                                        </div> 

                                        <div class="form-group row">
                                        <label>Keterangan</label>
                                            <input class="form-control" name="ket" rows="5" value="<?php echo $data['ket']; ?>"></input>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="">
                                                    ...
                                                    <button type="button" class="btn btn-danger waves-effect waves-light" onclick="window.location.href='dokter.php';">Cancel</button>
                                                </div>
                                            </div> <!-- /col -->
                                        </div> <!-- /row -->
                                    </form> <!-- /form -->
