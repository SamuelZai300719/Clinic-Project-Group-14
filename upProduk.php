                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="upProduk.php">Edit Data Produk</a></li>
                                        </ol>
                                    </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-12">
                                <div class="card-box">
                                    ...
                                    <form class="parsley-examples" method="post" action="upProdukK.php" enctype="multipart/form-data">
                                    <?php
                                        require 'koneksi.php';
                                        $id = $_GET['id_produk'];
                                    ...
                                    ?>
                                        ...
                                        <label>ID Produk</label>
                                            <input class="form-control" name="id_produk" type="int" value="<?php echo $data['id_produk']; ?>">
                                        </div>

                                        <div class="form-group row">
                                        <label>Nama Produk</label>
                                            <input class="form-control" name="nama_produk" type="text" value="<?php echo $data['nama_produk']; ?>">
                                        </div>

                                        <div class="form-group row">
                                        <label>Keterangan</label>
                                            <input class="form-control" name="ket_produk" type="text" rows="5" value="<?php echo $data['ket_produk']; ?>">
                                        </div> 

                                        <div class="form-group row">
                                        <label>Harga</label>
                                            <input class="form-control" name="harga" type="int" value="<?php echo $data['harga']; ?>">
                                        </div> 

                                        <div class="form-group row">
                                        <label>Stok</label>
                                            <input class="form-control" name="stok" value="<?php echo $data['stok']; ?>"></input>
                                        </div>

                                        <div class="form-group row">
                                        <label>Foto Produk</label>
                                            <input class="form-control" name="foto" type="file" value="<?php echo $data['foto']; ?>" width="300" height="100" />
                                        </div>
                                    <?php } ?>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="">
                                                    ...
                                                    <button type="button" class="btn btn-danger waves-effect waves-light" onclick="window.location.href='produk.php';">Cancel</button>
                                                </div>
                                            </div> <!-- /col -->
                                        </div> <!-- /row -->
                                    </form> <!-- /form -->
